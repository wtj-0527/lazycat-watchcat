...
```bash
docker build \
  --label org.opencontainers.image.version=1.12.7 \
  -t registry.cn-shanghai.aliyuncs.com/wtjking/lazycat-maoyan:1.12.7 .
docker push registry.cn-shanghai.aliyuncs.com/wtjking/lazycat-maoyan:1.12.7
