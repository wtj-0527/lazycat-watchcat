...
```bash
docker build \
  --label org.opencontainers.image.version=1.11.2 \
  -t registry.cn-shanghai.aliyuncs.com/wtjking/lazycat-maoyan:1.11.2 .
docker push registry.cn-shanghai.aliyuncs.com/wtjking/lazycat-maoyan:1.11.2
