...
```bash
docker build \
  --label org.opencontainers.image.version=1.4.44 \
  -t registry.cn-shanghai.aliyuncs.com/wtjking/lazycat-watchcat:1.4.44 .
docker push registry.cn-shanghai.aliyuncs.com/wtjking/lazycat-watchcat:1.4.44
